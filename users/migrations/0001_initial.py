    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('F', 'Feminino'), ('M', 'Masculino'), ('U', 'Não responder')], max_length=1)),
                ('image', models.ImageField(blank=True, upload_to='users/', verbose_name='Foto')),
